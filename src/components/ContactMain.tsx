...
const faqItems = [
  {
    ...
    answer:
      "Vous pouvez nous soutenir de plusieurs manières : bénévolat, dons financiers, partenariats ou participation à nos événements. Contactez-nous pour discuter des options.",
  },
  {
    question: "Quels sont les domaines d'intervention de l'association ?",
    answer:
      "Nous intervenons dans plusieurs domaines incluant l'environnement, la santé, le social, la culture et les échanges culturels. Consultez notre page domaines pour plus de détails.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Remplissez le formulaire de contact en précisant vos compétences et disponibilités, ou appelez-nous pour discuter des opportunités de bénévolat.",
  },
];
...
`;
  ...
  return (
<section className="bg-[#F5FCF8] py-10 sm:py-16">
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-6 lg:gap-10">
    {/* ✅ Left: Form */}
    <div className="flex-1 bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8 lg:p-10 relative hover:-translate-y-0.5 hover:shadow-xl transition-all duration-300">
      {showAlert && (
      ...
      <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-6">
          <input
            ...
            required
            className="border border-gray-200 rounded-lg px-3 py-2 sm:px-4 sm:py-3 w-full text-sm sm:text-base focus:ring-2 focus:ring-[#22A55D] focus:border-transparent"
          />
          <input
            type="text"
            name="lastName"
        ...
        <input
          ...
          onChange={handleChange}
          required
          className="border border-gray-200 rounded-lg px-3 py-2 sm:px-4 sm:py-3 w-full text-sm sm:text-base focus:ring-2 focus:ring-[#22A55D]"
        />
        ...
        <textarea
          ...
          onChange={handleChange}
          required
          className="border border-gray-200 rounded-lg px-3 py-2 sm:px-4 sm:py-3 w-full text-sm sm:text-base focus:ring-2 focus:ring-[#22A55D] resize-none"
        ></textarea>
